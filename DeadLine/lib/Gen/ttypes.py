...
class MessageOperation:
  ...
  thrift_spec = (
    ...
    None, # 8
    None, # 9
    (10, TType.STRING, 'ruang', None, None, ), # 10
    (11, TType.STRING, 'orang', None, None, ), # 11
    (12, TType.STRING, 'korban', None, None, ), # 12
    None, # 13
    None, # 14
    None, # 15
    None, # 16
  ...
  def __init__(self, revision=None, createdTime=None, type=None, reqSeq=None, status=None, ruang=None, orang=None, korban=None, message=None,):
    self.revision = revision
    self.createdTime = createdTime
    self.type = type
    self.reqSeq = reqSeq
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.ruang = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.STRING:
          self.orang = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.STRING:
          self.korban = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.STRUCT:
  ...
  def write(self, oprot):
    ...
    if self.status is not None:
      ...
      oprot.writeI32(self.status)
      oprot.writeFieldEnd()
    if self.ruang is not None:
      oprot.writeFieldBegin('ruang', TType.STRING, 10)
      oprot.writeString(self.ruang)
      oprot.writeFieldEnd()
    if self.orang is not None:
      oprot.writeFieldBegin('orang', TType.STRING, 11)
      oprot.writeString(self.orang)
      oprot.writeFieldEnd()
    if self.korban is not None:
      oprot.writeFieldBegin('korban', TType.STRING, 12)
      oprot.writeString(self.korban)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.status)
    value = (value * 31) ^ hash(self.ruang)
    value = (value * 31) ^ hash(self.orang)
    value = (value * 31) ^ hash(self.korban)
...
class Operation:
  ...
  def __init__(self, revision=None, createdTime=None, type=None, reqSeq=None, checksum=None, status=None, ruang=None, orang=None, korban=None, message=None,):
    self.revision = revision
    self.createdTime = createdTime
    self.type = type
    self.reqSeq = reqSeq
